...
final class ThunerWP {
	...
	public function __construct() {
		...
		add_action( 'redux/page/thunderwp/enqueue', array( __CLASS__, 'redux_scripts' ) );
	...
	public static function theme_setup() {
		/** Load text domain */
		load_theme_textdomain( 'thunderwp', THUNDERWP_THEME_URI . '/languages' );
		...
		register_nav_menus(
			array(
				'main-menu' => esc_html__( 'منوی سربرگ', 'thunderwp' ),
			)
		);
	...
	public static function register_sidebars() {
		$heading = 'h2';
		$heading = apply_filters( 'thunderwp_sidebar_heading', $heading );
	...
	public static function admin_scripts() {
		wp_register_style( 'thunderwp-admin', THUNDERWP_THEME_URI . '/assets/dist/css/admin.min.css', false, THUNDERWP_THEME_VERSION, 'all' );
		wp_enqueue_style( 'thunderwp-admin' );
	}
	...
	public static function redux_scripts() {
		wp_register_style( 'thunderwp-redux', THUNDERWP_THEME_URI . '/assets/dist/css/redux.min.css', array( 'redux-admin-css' ), THUNDERWP_THEME_VERSION, 'all' );
		wp_enqueue_style( 'thunderwp-redux' );
	}
	...
	public static function theme_css() {
		...
		wp_register_style( 'thunderwp-style', THUNDERWP_THEME_URI . '/assets/dist/css/main.min.css', false, THUNDERWP_THEME_VERSION, 'all' );
		wp_enqueue_style( 'thunderwp-style' );

		/** Register Flickity Carousel CSS */
		wp_register_style( 'thunderwp-flickity-carousel', THUNDERWP_THEME_URI . '/assets/dist/css/flickity.min.css', false, '2.2.1', 'all' );
	}
	...
	public static function theme_javascript() {
		...
		wp_register_script( 'thunderwp-flickity-carousel', THUNDERWP_THEME_URI . '/assets/js/libraries/flickity.pkgd.min.js', false, '2.2.1', true );
		...
		wp_register_script( 'thunderwp-javascript', THUNDERWP_THEME_URI . '/assets/dist/js/main.min.js', false, THUNDERWP_THEME_VERSION, true );
		wp_enqueue_script( 'thunderwp-javascript' );
	...
	public static function add_defer_data_scripts() {
		$handles = array(
			'thunderwp-flickity-carousel',
			'thunderwp-javascript',
		);
		$handles = apply_filters( 'thunderwp_defer_scripts', $handles );
	...
	public static function html5_shiv() {
		wp_register_script( 'html5shiv', THUNDERWP_THEME_URI . '/assets/dist/js/html5shiv.min.js', false, '3.7.3', true );
